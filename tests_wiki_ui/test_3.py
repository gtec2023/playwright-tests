...
@pytest.mark.mycustom_mark
def test_dark_knight_page(playwright: Playwright) -> None:
    browser = playwright.chromium.launch(headless=False,
                                         slow_mo=0)  #TODO add slow_mo to see whats happening - waits these ms on each step
